        ...
        if config.continuous_mode:
            ...
            if success:
                ...
                if status == "success":
                    ...
                    # Usage instructions
                    logger.info(f"\nICS Files Usage:")
                    logger.info(f"  - Individual .ics files: Import each file separately")
                    logger.info(f"  - Combined .ics file: Import all events at once")
                    logger.info(f"  - Cancellation .ics file: Import to remove old events")
                    logger.info(f"  - Manual deletion .txt: Backup option for manual removal")
                    logger.info(f"  - All times are in Ukraine timezone (Europe/Kiev)")
